...
| 6 | Tier 2 인터랙티브 디버거(break/inspect/eval/step) | 중~높음 | L | P2 | ⬜ 보류(probe와 중복) |
...
완료: #1·#2·#3·#5·#7·#8·#9·#10 (대시보드는 인터랙티브 스크린샷으로 차별화 결론).
보류(전부 조사 후 근거 있는 보류): #4(e2e — 전제 소멸), #6(Tier2 디버거 — probe와 중복),
